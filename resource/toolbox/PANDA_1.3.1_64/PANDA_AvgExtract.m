...
elseif isempty(AvgExtract_ResultantFolder)
    ...
    system(['fslval ' AvgExtract_ClusterImage ' dim1 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
    ClusterImage_dim1 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
    system(['fslval ' AvgExtract_ClusterImage ' dim2 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
    ClusterImage_dim2 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
    system(['fslval ' AvgExtract_ClusterImage ' dim3 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
    ClusterImage_dim3 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
    system(['fslval ' AvgExtract_ClusterImage ' pixdim1 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
    ClusterImage_pixdim1 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
    system(['fslval ' AvgExtract_ClusterImage ' pixdim2 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
    ClusterImage_pixdim2 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
    system(['fslval ' AvgExtract_ClusterImage ' pixdim3 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
    ClusterImage_pixdim3 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
    
    for i = 1:length(AvgExtract_ImagesList)
        system(['fslval ' AvgExtract_ImagesList{i} ' dim1 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
        SubjectImage_dim1 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
        system(['fslval ' AvgExtract_ImagesList{i} ' dim2 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
        SubjectImage_dim2 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
        system(['fslval ' AvgExtract_ImagesList{i} ' dim3 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
        SubjectImage_dim3 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
        system(['fslval ' AvgExtract_ImagesList{i} ' pixdim1 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
        SubjectImage_pixdim1 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
        system(['fslval ' AvgExtract_ImagesList{i} ' pixdim2 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
        SubjectImage_pixdim2 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
        system(['fslval ' AvgExtract_ImagesList{i} ' pixdim3 > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
        SubjectImage_pixdim3 = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
    ...
    for i = 1:length(ClusterIndex)
        ...
        for j = 1:length(AvgExtract_ImagesList)
            system(['fslstats ' AvgExtract_ImagesList{j} ' -k ' TmpImg ' -M > ' pwd filesep 'PANDA_AvgExtract_System.txt']);
            Array_Data{j, i} = load([pwd filesep 'PANDA_AvgExtract_System.txt']);
        end
    end
    delete([pwd filesep 'PANDA_AvgExtract_System.txt']);
    delete([TmpImg '.gz']);
