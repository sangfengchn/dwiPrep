...
elseif isempty(MapAtlas_ResultantFolder)
    ...
    for i = 1:OriginAtlas_ROIQuantity
        ...
        for j = 1:length(RegionI_AnatomicalAtlas_Index)
            ...
            MapAtlas(i, (j - 1) * 2 + 1) = RegionI_AnatomicalAtlas_Index(j);
            MapAtlas(i, j * 2) = RegionI_AnatomicalAtlas_Portion(j);
        end
        fprintf(fid, '\n');
        save([MapAtlas_ResultantFolder filesep 'MapAtlas.mat'], 'MapAtlas');
