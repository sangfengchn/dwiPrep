...
matlab -r "addpath(genpath('$RESOURCE/toolbox/PANDA_1.3.1_64')); g_DeterministicNetwork('$subDerPath/tmp/tracks_filtered.trk', '$subDerPath/tmp/aal3v1.nii.gz', '$subDerPath/tmp/dtifit_FA.nii.gz'); exit;"
